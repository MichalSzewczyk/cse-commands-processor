...
public class KafkaEventsProducer<T> implements CommandProducer<T> {
    ...
    public KafkaEventsProducer(Function<T, String> toStringMapper, ProducerConfiguration configuration) {
    ...
    public void produce(T value) {
        ...
        ProducerRecord<String, String> producerRecord = getProducerRecord(value);
        producer.send(producerRecord);
    }

    private ProducerRecord<String, String> getProducerRecord(T value) {
        String serializedMessage = toStringMapper.apply(value);
        return new ProducerRecord<>(topic, serializedMessage);
    }
}
